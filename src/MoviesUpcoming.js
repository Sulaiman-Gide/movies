...
const URL="https://api.themoviedb.org/3/movie/upcoming?api_key=ee94dbeaf7accfa25f1a8ba5568400fa";
  ...
  useEffect(() => {
    ...
    return (
      <div className="TopRated--page">
       ...
       {movies.length > 0 && <div className="Top--Rated--div start" >
          <span>
            <p className="Coloured--heading"> StartNet Specials</p>
            <h1 className="Top--Rated--heading">Movies:<span> Upcoming</span></h1>
          </span>
        </div>}
        {movies.length > 0 &&
