...
const URL="https://api.themoviedb.org/3/movie/now_playing?api_key=ee94dbeaf7accfa25f1a8ba5568400fa";
    ...
    return (
      <div className="TopRated--page">
       ...
       {movies.length > 0 && <div className="Top--Rated--div" >
          <span>
            <h1 className="Top--Rated--heading">Movies:<span> Now Playing</span></h1>
          </span>
        </div>}
        {movies.length > 0 &&
