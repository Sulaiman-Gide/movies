...
const URL="https://api.themoviedb.org/3/trending/all/day?api_key=ee94dbeaf7accfa25f1a8ba5568400fa";
    ...
    return (
      <div className="TopRated--page">
       ...
       {movies.length > 0 && <div className="Top--Rated--div start" >
          <span>
            <h1 className="Top--Rated--heading">Specials:<span> All Trending</span></h1>
          </span>
        </div>}
        {movies.length > 0 &&
